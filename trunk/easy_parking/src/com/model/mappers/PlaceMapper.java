...
public class PlaceMapper {
	...
	/**
	 * M�thode permettant de mapper l'objet PlaceDAO en bean Place
	 * @param place : la place r�cup�r� depuis le webservice
	 * @return une place
	 */
	...
	/**
	 * M�thode permettant de mapper l'objet PlaceFullDAO en bean Place
	 * @param place : la place r�cup�r�e depuis le webservice
	 * @return place
	 */
